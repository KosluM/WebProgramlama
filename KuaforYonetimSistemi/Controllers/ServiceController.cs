...
namespace KuaforYonetimSistemi.Controllers
{
    public class ServiceController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ServiceName,Duration,Price")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ServiceName,Duration,Price")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
